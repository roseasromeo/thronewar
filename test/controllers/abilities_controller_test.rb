...
class AbilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ability" do
    assert_difference('Ability.count') do
      post abilities_url, params: { ability: { long_text: @ability.long_text, name: @ability.name, short_text: @ability.short_text } }
    end
  ...
  test "should update ability" do
    patch ability_url(@ability), params: { ability: { long_text: @ability.long_text, name: @ability.name, short_text: @ability.short_text } }
