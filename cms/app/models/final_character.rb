class FinalCharacter < ActiveRecord::Base
  ...
  belongs_to :user
  has_many :start_ranks, dependent: :destroy
  has_many :final_ranks, dependent: :destroy
  ...
  accepts_nested_attributes_for :final_ranks, reject_if: :all_blank, allow_destroy: false
end
